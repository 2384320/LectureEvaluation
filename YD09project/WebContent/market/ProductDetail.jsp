		...
		<div class="main_board">
			<div class="board_detail">
				<div class="detail_board">
					<img title="<%=product.getProname() %>" src="data/<%=product.getImage() %>" width="250px">
				</div>
				...
				<div class="detail_btn">
					...
					<div class="btnss">
						<input class="btn" type="button" value="목 록" onClick="location.href='../index.jsp?CONTENTPAGE=market/ProductList.jsp'">
					</div>
				</div>
			</div>
		</div>
