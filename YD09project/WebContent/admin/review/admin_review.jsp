...
<body>
	...
	<div class="review" align="center">
			...
			<div class="review_board">
				...
				<div class="review_body">
					...
					<div class="padding">
						...
						<div class="horizontal">
							<a href="Javascript:reviewDelete('<%=evaBean.getEvaluationID()%>')">삭제</a>
						</div>
					</div>
				</div>
			</div>
						...
						<%
							for (int i = 1; i <= re_pageSu; i++) {
								if (i == re_spage) {
									...
									out.print("<a class='selected_a' href='admin_index.jsp?contentPage_admin=review/admin_review.jsp&page=" + i + "' >[" + i + "]</a>");
								}
							}
						%> <br> <br>
						<form action="admin_index.jsp?contentPage_admin=review/admin_review.jsp&page=<%=re_spage%>" name="frm" method="post">
							<select class="searchSelect" name="stype">
								<option value="lectureName" selected="seleted">강의명</option>
		...
		<form action="review/admin_reviewDelete.jsp" name="re_delete" method="post">
